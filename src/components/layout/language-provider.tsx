...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    hlsNetworkError: "Broadcast source error — stream is temporarily offline or undergoing maintenance",
  ...
  id: {
    ...
    hlsNetworkError: "Gangguan siaran — saluran sedang tidak aktif atau dalam pemeliharaan",
